  ...
  return (
    <main className="container mx-auto px-4 py-10">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p>
          Our Service allows you to stream anime content, post comments, and interact with other users. You 
          are responsible for the content you post and your conduct on the platform.
        </p>
        <p>
          You agree not to:
        </p>
        ...
        <p>
          Some features of the Service may require a subscription. By subscribing to a paid plan, you agree to 
          pay the fees listed at the time of purchase.
        </p>
        <p>
