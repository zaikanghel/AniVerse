  ...
  return (
    <main className="container mx-auto px-4 py-10">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <p className="lead">
          At AnimeVerse, we respect your privacy and are committed to protecting your personal data.
        ...
        <ul>
          ...
          <li>
            <strong>Usage Data:</strong> Information about how you interact with our platform, including your viewing history, 
            search queries, and favorite content.
          </li>
          <li>
            <strong>Device Information:</strong> We collect information about the device and browser you use to access our service, 
            including your IP address, browser type, and operating system.
          </li>
          <li>
            <strong>Cookies and Similar Technologies:</strong> We use cookies and similar tracking technologies to enhance your 
            experience on our platform and to collect information about your browsing activities.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>To personalize your experience and recommend content based on your preferences</li>
        ...
        <ul>
          ...
          <li>
            <strong>Business Partners:</strong> Companies we partner with to offer joint promotions or services.
          </li>
          <li>
